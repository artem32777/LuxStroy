    ...
    (() => {
        ...
        function Zoom({swiper, extendParams, on, emit}) {
            ...
            function onGestureStart(e) {
                if ("mouse" === e.pointerType) evCache.splice(0, evCache.length);
            ...
            function zoomIn(e) {
                ...
                if (1 === currentScale && forceZoomRatio) {
                    touchX = void 0;
                    touchY = void 0;
                }
                zoom.scale = forceZoomRatio || gesture.imageWrapEl.getAttribute("data-swiper-zoom") || params.maxRatio;
                currentScale = forceZoomRatio || gesture.imageWrapEl.getAttribute("data-swiper-zoom") || params.maxRatio;
                if (e && !(1 === currentScale && forceZoomRatio)) {
        ...
        function initSliders() {
            ...
            if (document.querySelector(".staff__slider")) new core(".staff__slider", {
...
***************************************************************************** */
        ...
        lightgallery_es5(document.getElementById("gallery"), {
            selector: ".portfolio__slide-image",
